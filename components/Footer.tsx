...
const footerLinks = {
  ...
  company: [
    ...
    { name: "Blog", href: "#" },
    { name: "Careers", href: "#" },
    { name: "Contact", href: "mailto:support@meetmatch.app" },
  ],
  legal: [
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold">MeetMatch</span>
            </a>
            <p className="mt-4 text-gray-400 max-w-sm">
              The dating app that uses fair comparisons and ELO ratings to help
